...
fig, axes = fig_setup.setup_raw(fig_title="Raw(Actual): All Subject", channels=channels)
...
for i in range(5):
  pathName = f'../../../result/subject_{i+1}/actual/'
  if test_flag:
    pathName = f'../../../result/test_{test_num}/subject_{i+1}/actual/'
